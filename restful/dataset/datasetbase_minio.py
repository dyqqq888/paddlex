...
class DatasetBase_minio(object):
    def __init__(self, dataset_id, path,endpoint,folder):
        ...
        self.minioClient = Minio(endpoint,access_key='admin',secret_key='12345678',secure=False)
        self.minioClientFolder = folder
    ...
    def split(self, val_split, test_split):
        ...
        assert train_num > 0, "The number of training set samples must be greater than 0"
        assert val_num > 0, "The number of validation set samples must be greater than 0"
